...
def filter_targets(online_targets, aspect_ratio_thresh, min_box_area,dataset_):
    ...
    for t in online_targets:
        ...
        if dataset_ in ['BEE24', 'gmot', 'bird_drone']:
...
def dti(txt_path, save_path, n_min=30, n_dti=20):
    ...
    for seq_txt in seq_txts:
        ...
        if seq_data is None or seq_data.ndim==1:
            continue
...
if __name__ == "__main__":
    post_folder = "results/trackers/mva_test_post"
    pre_folder = "results/trackers/mva_test"
