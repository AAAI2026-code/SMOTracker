...
def make_parser():
    ...
    parser.add_argument("--demo_type", default="image", help="demo type, eg. image, videos and webcam")
    parser.add_argument("--path", default="./videos/demo.mp4", help="path to images or videos")
