...
from external.adaptors import yolox_adaptor,g_dino_adaptor


class Detector(torch.nn.Module):
    K_MODELS = {"yolox","g_dino"}
    ...
    def initialize_model(self):
        ...
        elif self.model_type=="g_dino":
            self.model =g_dino_adaptor.get_model(self.path)
